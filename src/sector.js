class Sector {
    static getId(sectorName) {
        ...
        return this.#name_ids[sectorName];
    }

    static getName(sectorId) {
        const s = this.#catalogue[sectorId];
        return s !== undefined ? s.n : undefined;
    }

    static getLocation(sectorId, x, y) {
        const s = this.#catalogue[sectorId];
        return s !== undefined ? s.lb + s.h * x + y : undefined;
    }

    static getCoords(sectorId, location) {
        const s = this.#catalogue[sectorId];
    ...
    static getIdFromLocation(location) {
        var min = Infinity,
            sectorId;
        this.#catalogue.forEach((sector, ind) => {
    ...
    // lazily initialized in Sectors.getId
    static #name_ids;
